...
def test_list_uses_correct_url_ad_template(auto_login_user):  # noqa: F811
    ...
    links = [
        {
            "link": "signature:signature_list",
            "template": "signature/signature_list.html",
        },
        {
            "link": "signature:signature_search",
            "template": "signature/signature_list.html",
        },
...
def test_details_url(auto_login_user):  # noqa: F811
    ...
    links = [
        {
            "model": Signature,
            "link": "signature:signature-detail",
            "template": "signature/signature_detail.html",
        },
        {
            "model": Signature,
            "link": "signature:signature-update",
            "template": "Forms/add.html",
        },
        {
            "model": Signature,
            "link": "signature:signature-delete",
