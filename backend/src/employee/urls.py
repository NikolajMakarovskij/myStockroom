...
urlpatterns = [
    ...
    re_path(
        r"^employee/(?P<pk>[-\w]+)/update$",
        EmployeeUpdate.as_view(),
        name="employee-update",
    ),
    re_path(
        r"^employee/(?P<pk>[-\w]+)/delete$",
    ...
    path(
        "departament/search", DepartamentListView.as_view(), name="departament_search"
    ),
    re_path(
        r"^departament/(?P<pk>[-\w]+)$",
        DepartamentDetailView.as_view(),
        name="departament-detail",
    ),
    re_path(
        r"^departament/create/$", DepartamentCreate.as_view(), name="new-departament"
    ),
    re_path(
        r"^departament/(?P<pk>[-\w]+)/update$",
        DepartamentUpdate.as_view(),
        name="departament-update",
    ),
    re_path(
        r"^departament/(?P<pk>[-\w]+)/delete$",
        DepartamentDelete.as_view(),
