...
def test_list_uses_correct_url_nad_template(auto_login_user):  # noqa F811
    ...
    links = [
        ...
        {
            "link": "employee:departament_list",
            "template": "employee/departament_list.html",
        },
        {
            "link": "employee:departament_search",
            "template": "employee/departament_list.html",
        },
...
def test_details_url(auto_login_user):  # noqa F811
    ...
    links = [
        {
            "model": Employee,
            "link": "employee:employee-detail",
            "template": "employee/employee_detail.html",
        },
        {
            "model": Employee,
            "link": "employee:employee-update",
            "template": "Forms/add.html",
        },
        {
            "model": Employee,
            "link": "employee:employee-delete",
            "template": "Forms/delete.html",
        },
        {
            "model": Post,
            "link": "employee:post-detail",
            "template": "employee/post_detail.html",
        },
        {"model": Post, "link": "employee:post-update", "template": "Forms/add.html"},
        {
            "model": Post,
            "link": "employee:post-delete",
            "template": "Forms/delete.html",
        },
        {
            "model": Departament,
            "link": "employee:departament-detail",
            "template": "employee/departament_detail.html",
        },
        {
            "model": Departament,
            "link": "employee:departament-update",
            "template": "Forms/add.html",
        },
        {
            "model": Departament,
            "link": "employee:departament-delete",
            "template": "Forms/delete.html",
        },
    ]
    for each in links:
