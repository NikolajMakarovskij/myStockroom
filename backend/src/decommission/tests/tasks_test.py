...
def test_decom_add_devices(client):
    ...
    assert test_get_decom.categories.name == "my_category"  # type: ignore[attr-defined]
    assert test_get_decom.categories.slug == "my_category"  # type: ignore[attr-defined]
...
def test_disp_add_devices(client):
    ...
    assert HistoryDev.objects.count() == 3
    assert test_get_disp.categories.name == "my_category"  # type: ignore[attr-defined]
    assert test_get_disp.categories.slug == "my_category"  # type: ignore[attr-defined]
