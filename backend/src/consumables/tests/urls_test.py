...
def test_list_url_exists_at_desired_location(auto_login_user):  # noqa F811
    ...
    links = [
        ...
        "/consumables/consumables/search",
        "/consumables/accessories/",
        "/consumables/accessories/search",
    ]
    for link in links:
        url = link
...
def test_list_uses_correct_url_nad_template(auto_login_user):  # noqa F811
    ...
    links = [
        {
            "link": "consumables:consumables_index",
            "template": "consumables/consumables_index.html",
        },
        {
            "link": "consumables:consumables_list",
            "template": "consumables/consumables_list.html",
        },
        {
            "link": "consumables:consumables_search",
            "template": "consumables/consumables_list.html",
        },
        {"link": "consumables:new-consumables", "template": "Forms/add.html"},
        {
            "link": "consumables:accessories_list",
            "template": "consumables/accessories_list.html",
        },
        {
            "link": "consumables:accessories_search",
            "template": "consumables/accessories_list.html",
        },
...
def test_details_url(auto_login_user):  # noqa F811
    ...
    links = [
        {
            "model": Consumables,
            "link": "consumables:consumables-detail",
            "template": "consumables/consumables_detail.html",
        },
        {
            "model": Consumables,
            "link": "consumables:consumables-update",
            "template": "Forms/add.html",
        },
        {
            "model": Consumables,
            "link": "consumables:consumables-delete",
            "template": "Forms/delete.html",
        },
        {
            "model": Accessories,
            "link": "consumables:accessories-detail",
            "template": "consumables/accessories_detail.html",
        },
        {
            "model": Accessories,
            "link": "consumables:accessories-update",
            "template": "Forms/add.html",
        },
        {
            "model": Accessories,
            "link": "consumables:accessories-delete",
            "template": "Forms/delete.html",
        },
    ]
