...
def test_list_uses_correct_url_nad_template(auto_login_user):  # noqa: F811
    ...
    links = [
        {
            "link": "accounting:accounting_index",
            "template": "accounting/accounting_index.html",
        },
        {
            "link": "accounting:accounting_list",
            "template": "accounting/accounting_list.html",
        },
        {
            "link": "accounting:accounting_search",
            "template": "accounting/accounting_list.html",
        },
        {"link": "accounting:new-accounting", "template": "Forms/add.html"},
        {
            "link": "accounting:categories_list",
            "template": "accounting/categories_list.html",
        },
        {
            "link": "accounting:categories_search",
            "template": "accounting/categories_list.html",
        },
...
def test_details_url(auto_login_user):  # noqa: F811
    ...
    links = [
        {
            "model": Accounting,
            "link": "accounting:accounting-detail",
            "template": "accounting/accounting_detail.html",
        },
        {
            "model": Accounting,
            "link": "accounting:accounting-update",
            "template": "Forms/add.html",
        },
        {
            "model": Accounting,
            "link": "accounting:accounting-delete",
