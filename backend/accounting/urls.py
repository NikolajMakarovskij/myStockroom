...
from .views import AccountingIndexView, AccountingView, AccountingCategoriesView, AccountingDetailView, \
    AccountingCreate, AccountingUpdate, AccountingDelete, CategoryView, CategoryCreate, \
