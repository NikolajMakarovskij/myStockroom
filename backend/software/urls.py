...
from .views import SoftwareListView, SoftwareDetailView, SoftwareCreate, SoftwareUpdate, SoftwareDelete, OSListView, \
    OSDetailView, OSCreate, OSUpdate, OSDelete, IndexView
...
urlpatterns = [
    ...
    re_path(r'^software/(?P<pk>[-\w]+)$', SoftwareDetailView.as_view(), name='software-detail'),
    re_path(r'^software/create/$', SoftwareCreate.as_view(), name='new-software'),
    re_path(r'^software/(?P<pk>[-\w]+)/update$', SoftwareUpdate.as_view(), name='software-update'),
    re_path(r'^software/(?P<pk>[-\w]+)/delete$', SoftwareDelete.as_view(), name='software-delete'),
    # ОС
