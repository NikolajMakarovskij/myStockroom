...
def test_list_url_exists_at_desired_location(auto_login_user):
    ...
    links = ['/workplace/', '/workplace/workplace/', '/workplace/workplace/search',
             '/workplace/room/', '/workplace/room/search']
    for link in links:
        url = link
...
def test_list_uses_correct_url_nad_template(auto_login_user):
    client, user = auto_login_user()
    links = [
        {'link': 'workplace:workplace_index', 'template': 'workplace/workplace_index.html'},
...
@pytest.mark.django_db
def test_ups_detail_url(auto_login_user):
    client, user = auto_login_user()
    links = [
