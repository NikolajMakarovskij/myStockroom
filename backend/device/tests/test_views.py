...
class TestDeviceEndpoints:
    ...
    def test_device_list(self, auto_login_user):
        ...
        Device.objects.bulk_create([
            Device(name='01', categories=cat, manufacturer=man, workplace=workplace_1),
    ...
    @pytest.mark.django_db
    def test_device_list_2(self, auto_login_user):
        Room.objects.get_or_create(name='01', building='01')
        room = Room.objects.get(name='01')
        Workplace.objects.get_or_create(name='01', room=room)
        Workplace.objects.get_or_create(name='02', room=room)
    ...
    @pytest.mark.django_db
    def test_no_accounting(self, auto_login_user):
        client, user = auto_login_user()
        Device.objects.get_or_create(name='10')
        response = client.get(
            '/api/device/device_list/'
    ...
    @pytest.mark.django_db
    def test_in_stock(self, auto_login_user):
        client, user = auto_login_user()
        Device.objects.get_or_create(name='10')
    ...
    @pytest.mark.django_db
    def test_in_decommission(self, auto_login_user):
        client, user = auto_login_user()
        Device.objects.get_or_create(name='10')
        device = Device.objects.get(name='10')
    ...
    @pytest.mark.django_db
    def test_in_disposal(self, auto_login_user):
        client, user = auto_login_user()
        Device.objects.get_or_create(name='10')
        device = Device.objects.get(name='10')
