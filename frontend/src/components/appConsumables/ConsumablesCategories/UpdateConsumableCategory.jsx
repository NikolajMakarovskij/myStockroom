...
const UpdateConsumableCategory = () => {
    const CSRF = useCSRF()
    ...
    const submission = (data) => {
        AxiosInstanse.put(`consumables/consumable_category/${catId}/`,{
                name: data.name,
                slug: data.slug,
        },{
            headers: {
                    ...
                    <Box>
                        <ThemeProvider theme={darkTheme}>
                            ...
                            >
                                ...
                                <Button variant='contained' component={Link} to={`/consumables/categories/list`}>Отмена</Button>
                            </Box>
                        </ThemeProvider>
                    </Box>
                </Box>
...
export default UpdateConsumableCategory