...
urlpatterns = [
    # софт
    path('', SoftwareListView.as_view(), name='software_list'),
    path('search', SoftwareListView.as_view(), name='software_search'),
    re_path(r'^(?P<pk>[-\w]+)$', SoftwareDetailView.as_view(), name='software-detail'),
    re_path(r'^create/$', SoftwareCreate.as_view(), name='new-software'),
